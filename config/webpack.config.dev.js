...
// console.log(env.raw.CONFIG_FILES.development)
...
module.exports = {
  ...
  entry: {
    ...
    hot: require.resolve('../scripts/utils/webpackHotDevClient'),

    // Errors should be considered fatal in development
    error: require.resolve('react-error-overlay'),

    dapp: paths.dappIndexJs
  ...
  plugins: [
    // Generates an `dapp.html` file with the <script> injected.
